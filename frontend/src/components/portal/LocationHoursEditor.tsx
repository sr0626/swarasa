              ...
              {!day.is_closed && (
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="h-11 rounded-brand-control border border-brand-border bg-white px-2 text-base text-brand-ink focus:border-brand-accent focus:outline-none sm:text-sm"
                  />
